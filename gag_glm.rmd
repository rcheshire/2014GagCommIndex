...
par(las=2,cex.lab=1.0,oma=c(0,15,0,0))
barplot(coeff,horiz=T,xlim=c(-1.0,1), xlab='Regression coefficient')
savePlot(file="sppcorr4.pdf",type="pdf")
...
plot(prob.trp[550:650],abs.dif[550:650]/1000,type="l",
     xlab="Probability", ylab="Abs. error (1000)")
savePlot(file="minimum4.pdf",type="pdf")
...
# savePlot(file="poshist.pdf",type="pdf")
...
hist(log(dat.pos$cpue),breaks=40,freq=FALSE,right=TRUE,xlab='Log CPUE (whole pounds/hook-hour)',main='Gag pos commercial CPUE') 
  ...
  savePlot(file="histLogPos.pdf",type="pdf") 
```
...
savePlot(file="yearresid.pdf",type="pdf")
```
...
savePlot(file="monthresid.pdf",type="pdf")
```
...
savePlot(file="stateresid.pdf",type="pdf")
```
...
savePlot(file="stbymonresid.pdf",type="pdf")
...
savePlot(file="boot-index.pdf",type="pdf")

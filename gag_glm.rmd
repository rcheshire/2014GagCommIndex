...
```{r setupGLMm1,warning=FALSE,message=FALSE,echo=FALSE}
...
```{r setupGLMm2,warning=FALSE,message=FALSE,echo=FALSE}
trips.pred=mat2.df[fit$fitted.values>min.prob,]
select.trips=c(rownames(trips.pred))
...
```{r setupGLMm3,warning=FALSE,message=FALSE,echo=FALSE}
trips.pred=mat2.df[fit$fitted.values>min.prob,]
select.trips=c(rownames(trips.pred))
...
```{r compareMethods,warning=FALSE,message=FALSE,echo=FALSE}
plot(rownames(gagm3.ln$deltaGLM.index),gagm3.ln$deltaGLM.index$index,type='n',xlab='',ylab='Pounds/hook-hr')
lines(rownames(gagm3.ln$deltaGLM.index),gagm3.ln$deltaGLM.index$index,lty=1,lwd=2,col='blue')
lines(rownames(gagm2.ln$deltaGLM.index),gagm2.ln$deltaGLM.index$index,lty=2,lwd=2,col='darkorange')
lines(rownames(gagm1.ln$deltaGLM.index),gagm1.ln$deltaGLM.index$index,lty=3,lwd=2,col='darkgreen')
legend('topleft',lty=c(1,1,1),lwd=c(2,2,2), col=c('blue','darkorange','darkgreen'),legend=c('method 3', 'method 2', 'method 1'))

...
require(xtable)
library(matlab)
setwd("W:/SEDAR/Updates2014/Gag/Indicies/CommHL")
...
```{r sample size, results='asis',echo=FALSE}
...
```{r binaryMatrix, echo=FALSE}
###########Create Binary Matrix for Stephens and MacCall#####
dat=read.csv('tripspecies.csv',header=T)
NMFSspp.codes=read.csv('NMFSsppcodes.csv',header=T)
...
toc()
tic()
write.table(mat,file='lgbk.dat',quote=F,sep=",")
toc()
